...
namespace VeggieRecipe.WebApp.Pages.FavoriteRecipes
{
    public class EditModel : PageModel
    {
        ...
        public void OnGet(int id)
        {
            ...
            Recipe = RecipeService.GetById(FavoriteRecipe.RecipeId.Id);
        }
        ...
        public IActionResult OnPost(int id)
        {
            ...
            favoriteRecipe.Id = Convert.ToInt32(Request.Form["id"]);
            favoriteRecipe.UserId.Id = Convert.ToInt32(Request.Form["userId"]);
            favoriteRecipe.RecipeId.Id = Convert.ToInt32(Request.Form["recipeId"]);

            FavoriteRecipeService.Update(favoriteRecipe);

            return Redirect("/FavoriteRecipes/ListAll");
        }
